...
def assistant():
    ...
    try:
        ...
        if 'hello'in command or 'Hello' in command:
            ser1.write('h'.encode())
            return()
        elif 'up' in command or 'Up' in command:
            ser1.write('u'.encode())
            return()
        elif 'open' in command or 'Open' in command:
            ser1.write('o'.encode())
            return()
        elif 'close' in command or 'Close' in command:
            ser1.write('c'.encode())
            return()
        elif 'reset' in command or 'Reset' in command or 'initial' in command or 'Initial' in command:
            ser1.write('i'.encode())
            return()
        elif 'back' in command or 'Back' in command or 'reverse' in command or 'Reverse' in command:
            ser1.write('b'.encode())
            return()
        elif 'forward' in command or 'front' in command or 'Forward' in command or 'Front' in command:
            ser1.write('f'.encode())
            return()
        elif 'move left' in command or 'Move Left' in command:
            ser1.write('l'.encode())
            return()
        elif 'move right' in command or 'Move right' in command:
            ser1.write('r'.encode())
            return()
        elif 'left' in command or 'Left' in command:
            ser1.write('n'.encode())
            return()
        elif 'right' in command or 'Right' in command:
            ser1.write('m'.encode())
            return()
            ...
            recall()
            return()
        elif 'shut down' in command or 'shutdown' in command or 'Shutdown' in command or 'Shut down' in command or 'Shut Down' in command:
            talk('Shutting down. Goodbye.')
            shut_down=1
            return()
        elif 'down' in command or 'Down' in command:
            ser1.write('d'.encode())
            return()
